...
**-Stock options:** Some software engineers recieve stock option as part of their compensation package, which can provide a finacial return if the company's stock price increases.
